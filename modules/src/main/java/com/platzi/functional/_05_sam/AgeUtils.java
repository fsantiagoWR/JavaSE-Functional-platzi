    ...
    public static void main(String[] args) {
        ...
        TriFunction<Integer, Integer, Integer, LocalDate> parseDate =
                (day, month, year) -> LocalDate.parse(year + "-" +
                        addZeros.apply(month) + "-" + addZeros.apply(day));
        ...
        System.out.println(calculateAge.apply(14,02,1994));
    }

    @FunctionalInterface
    interface TriFunction<T, U, V, R>{
        R apply(T t,U u,V v); //Funcion que devuelve un R y recibe tres parametros (t,u,v del tipo T,U,V respectivamente)
    }
